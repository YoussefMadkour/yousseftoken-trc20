...
// Flattened contract for TRONScan verification
// Original: Token.sol with all dependencies included
...
/**
 * @title YoussefToken
 * @dev TRC20 Token where all tokens are pre-assigned to the creator.
 */
contract Token is TRC20, TRC20Detailed {
    constructor () public TRC20Detailed("YoussefToken", "YTN", 18) {
